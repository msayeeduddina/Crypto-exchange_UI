...
const MarketScreen = () => {
  ...
  useEffect(() => {
    const coinData = {
      ...
      amount: '18.783,33',
      description: `Bitcoin, Satoshi Nakamoto it is a cryptocurrency that was invented in 2008 by an unknown person or group who used its name. released as an open source software in 2009`,
    };
