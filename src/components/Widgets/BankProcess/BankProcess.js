        ...
        <div className='box-content box-horizontal-padding box-vertical-padding box-content-height-nobutton'>
          <form className='form' noValidate>
            <div className='form-elements'>
              <div className='form-line'>
                <div className='full-width'>
                  <label htmlFor='iban'>Add IBAN October</label>
                  <input type='text' name='iban' id='iban' placeholder='Enter the IBAN number' />
                </div>
              </div>
            </div>
          </form>
          ...
          <form className='form' noValidate>
            <div className='form-elements'>
              <div className='form-line'>
                <div className='full-width'>
                  <label htmlFor='view'>My Registered IBAN</label>
                  <select name='view' id='view'>
                    <option value='ZB'>Swiss bank</option>
                  </select>
                </div>
              </div>
            </div>
          ...
          <div className='box-text box-horizontal-padding center'>
            ...
            <p>
              <span>The amount to be withdrawn : </span>
              <strong>2376.00 RS</strong>
            </p>
          </div>
